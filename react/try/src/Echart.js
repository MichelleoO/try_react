...
class Echart extends React.Component{
    ...
    async componentDidMount() {
      ...
      myChart.on('click', e => {
        ...
        if (e.seriesName == 'scaatt') {
          ...
          this.setState({ dataBefore: dataBefore });
  ...
  handleSubmit () {
    if (this.props.onSubmit) {
      const { dataBefore, dataAfter } = this.state
      this.props.onSubmit({dataBefore, dataAfter})
    }
    ...
    render() {
        return (
          <div >
            ...
            <input value={this.state.dataBefore} hidden='hidden'readOnly={true}/>
            <input value={this.state.dataAfter} hidden='hidden'readOnly={true}/>
